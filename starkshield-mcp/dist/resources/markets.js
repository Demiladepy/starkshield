...
export function registerMarketResources(server) {
    server.registerResource("markets-vesu", "starknet://markets/vesu", {
        title: "Vesu markets",
            ...
            contents: [
                {
                    ...
                    mimeType: "application/json",
                    text: JSON.stringify(markets.map((m) => ({
                        protocol: m.protocol,
    ...
    server.registerResource("markets-tokens", "starknet://markets/tokens", {
        title: "Preset tokens",
        mimeType: "application/json",
    }, async () => {
            ...
            contents: [
                {
                    ...
                    mimeType: "application/json",
                    text: JSON.stringify(keys.map((k) => {
                        const t = presets[k];
