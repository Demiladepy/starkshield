import { Range } from "../provers/range";
import { CipherBalance, GeneralPrefixData, ProjectivePoint } from "../types";
...
export declare function proveTransfer(private_key: bigint, to: ProjectivePoint, initial_balance: bigint, amount_to_transfer: bigint, initial_cipherbalance: CipherBalance, nonce: bigint, bit_size: number, prefix_data: GeneralPrefixData): {
 ...
 */
export declare function verifyTransfer(inputs: InputsTransfer, proof: ProofOfTransfer): void;
