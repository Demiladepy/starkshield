...
import { type BridgingConfig, ChainId, type ExplorerConfig, type SDKConfig, type StakingConfig } from "./types/config.js";
...
import { type Address, type BridgeToken, ExternalChain, type Pool, type Token } from "./types/index.js";
...
export declare class StarkZap {
    ...
    protected ensureProviderChainMatchesConfig(): Promise<void>;
    /**
