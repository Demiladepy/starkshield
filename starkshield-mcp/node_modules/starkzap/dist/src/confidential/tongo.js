...
export class TongoConfidential {
    constructor(config) {
        ...
        this.account = new TongoAccount(config.privateKey, config.contractAddress, config.provider);
    }
     ...
     */
    async toConfidentialUnits(amount) {
     ...
     * using the on-chain rate.
     */
    async toPublicUnits(confidentialAmount) {
