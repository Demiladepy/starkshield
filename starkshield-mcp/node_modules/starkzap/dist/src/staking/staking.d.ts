import { type BigNumberish, type Call, type RpcProvider } from "starknet";
...
export declare class Staking {
     ...
     * ```
     */
    getPosition(walletOrAddress: WalletInterface | Address | BigNumberish): Promise<PoolMember | null>;
    /**
