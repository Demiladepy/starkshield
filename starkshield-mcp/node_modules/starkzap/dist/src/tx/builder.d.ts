...
import type { SwapInput } from "../swap/index.js";
import type { DcaCancelInput, DcaCreateInput } from "../dca/index.js";
import type { LendingBorrowRequest, LendingDepositRequest, LendingWithdrawMaxRequest, LendingRepayRequest, LendingWithdrawRequest } from "../lending/index.js";
import type { Address, Amount, ExecuteOptions, PreflightResult, Token } from "../types/index.js";
import type { ConfidentialProvider, ConfidentialFundDetails, ConfidentialTransferDetails, ConfidentialWithdrawDetails } from "../confidential/index.js";
/**
...
export declare class TxBuilder {
    ...
    private readonly pendingErrors;
    private sent;
    private sendPromise;
    constructor(wallet: WalletInterface);
    private queueAsyncCalls;
    private queueLendingAction;
    private queueDcaAction;
    private queuePreparedCalls;
    private throwPendingErrorsIfAny;
    /**
     ...
     * ```
     */
    confidentialFund(confidential: ConfidentialProvider, details: ConfidentialFundDetails): this;
    /**
     ...
     * ```
     */
    confidentialTransfer(confidential: ConfidentialProvider, details: ConfidentialTransferDetails): this;
    /**
     ...
     * ```
     */
    confidentialWithdraw(confidential: ConfidentialProvider, details: ConfidentialWithdrawDetails): this;
    /**
     ...
     * ```
     */
    estimateFee(): Promise<import("starknet").EstimateFeeResponseOverhead>;
    /**
     ...
     * ```
     */
    send(options?: ExecuteOptions): Promise<Tx>;
}
