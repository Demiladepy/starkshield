...
export class TxBuilder {
    ...
    queueLendingAction(action, preparedPromise) {
        return this.queuePreparedCalls(`Lending action "${action}" returned no calls`, preparedPromise);
    }
    queueDcaAction(action, preparedPromise) {
        return this.queuePreparedCalls(`DCA action "${action}" returned no calls`, preparedPromise);
    }
    queuePreparedCalls(emptyMessage, preparedPromise) {
    ...
    throwPendingErrorsIfAny() {
        ...
        const messages = errors
            .map((error) => error instanceof Error
            ? error.message
            : String(error ?? "Unknown async builder error"))
            .join("; ");
        throw new Error(`Multiple transaction builder operations failed: ${messages}`);
    }
    /**
    ...
    swap(request) {
        ...
        return this.queuePreparedCalls("Swap returned no calls", this.wallet.prepareSwap(request));
    }
    /**
     * Add a lending deposit operation.
     */
    lendDeposit(request) {
        return this.queueLendingAction("deposit", this.wallet.lending().prepareDeposit(request));
    }
    /**
     * Add a lending withdraw operation.
     */
    lendWithdraw(request) {
        return this.queueLendingAction("withdraw", this.wallet.lending().prepareWithdraw(request));
    }
    /**
     * Add a max-withdraw lending operation.
     */
    lendWithdrawMax(request) {
        return this.queueLendingAction("withdrawMax", this.wallet.lending().prepareWithdrawMax(request));
    }
    /**
     * Add a lending borrow operation.
     */
    lendBorrow(request) {
        return this.queueLendingAction("borrow", this.wallet.lending().prepareBorrow(request));
    }
    /**
     * Add a lending repay operation.
     */
    lendRepay(request) {
        return this.queueLendingAction("repay", this.wallet.lending().prepareRepay(request));
    }
    /**
     * Add a DCA order creation operation.
     */
    dcaCreate(request) {
        return this.queueDcaAction("create", this.wallet.dca().prepareCreate(request));
    }
    /**
     * Add a DCA cancellation operation.
     */
    dcaCancel(request) {
        return this.queueDcaAction("cancel", this.wallet.dca().prepareCancel(request));
    }
    /**
     ...
     * ```
     */
    confidentialFund(confidential, details) {
     ...
     * ```
     */
    confidentialTransfer(confidential, details) {
     ...
     * ```
     */
    confidentialWithdraw(confidential, details) {
