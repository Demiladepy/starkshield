import { type Address, Amount, type BridgeDepositFeeEstimation, type ExternalAddress, type ExternalTransactionResponse } from "../../types/index.js";
...
export interface BridgeInterface<A extends ExternalAddress = ExternalAddress> {
    ...
    deposit(recipient: Address, amount: Amount, options?: BridgeDepositOptions): Promise<ExternalTransactionResponse>;
    getDepositFeeEstimate(options?: BridgeDepositOptions): Promise<BridgeDepositFeeEstimation>;
    getAvailableDepositBalance(account: A): Promise<Amount>;
    getAllowance(): Promise<Amount | null>;
}
//# sourceMappingURL=BridgeInterface.d.ts.map