...
import type { SwapInput, SwapProvider, SwapProviderResolver, SwapRequest } from "../swap/interface.js";
export declare function resolveSwapSource(source: SwapProvider | string | undefined, resolver: SwapProviderResolver): SwapProvider;
