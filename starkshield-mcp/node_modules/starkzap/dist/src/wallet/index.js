...
export class Wallet extends BaseWallet {
    ...
    static async create(options) {
        const { account: accountInput, provider, config, accountAddress: providedAddress, feeMode = "user_pays", timeBounds, swapProviders, defaultSwapProviderId, dcaProviders, defaultDcaProviderId, } = options;
