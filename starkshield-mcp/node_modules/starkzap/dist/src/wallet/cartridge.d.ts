...
import { type BridgingConfig, ChainId, type DeployOptions, type EnsureReadyOptions, type ExecuteOptions, type FeeMode, type PreflightOptions, type PreflightResult, type ExplorerConfig, type StakingConfig } from "../types/index.js";
...
export declare class CartridgeWallet extends BaseWallet {
     ...
     */
    static create(options?: CartridgeWalletOptions, stakingConfig?: StakingConfig | undefined, bridgingConfig?: BridgingConfig | undefined): Promise<CartridgeWallet>;
