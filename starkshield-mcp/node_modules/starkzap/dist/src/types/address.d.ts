...
export type AddressInput = BigNumberish | {
 ...
 */
export declare function fromAddress(value: BigNumberish): Address;
/**
 ...
 */
export declare function resolveWalletAddress(value: AddressInput): Address;
/**
