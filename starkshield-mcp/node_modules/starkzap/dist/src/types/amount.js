...
const MAX_SCIENTIFIC_EXPONENT = 10000;
const NBSP = "\u00A0";
...
export class Amount {
    ...
    add(other) {
        ...
        return new Amount(this.baseValue + other.baseValue, this.decimals, this.symbol ?? other.symbol);
    }
    /**
 ...
 */
export function assertAmountMatchesToken(amount, token) {
 ...
 * ```
 */
export function tokenAmountToFormatted(compressed = false, balance, decimals, symbol) {
    assertValidDecimals(decimals);
